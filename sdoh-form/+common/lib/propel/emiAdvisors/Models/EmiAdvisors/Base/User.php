...
abstract class User implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\EmiAdvisors\\Map\\UserTableMap';
    ...
    /**
     * The value for the token_expire_ts field.
     *
     * @var        DateTime
     */
    protected $token_expire_ts;
    ...
    /**
     * Initializes internal state of EmiAdvisors\Base\User object.
     * @see applyDefaults()
     */
    ...
    /**
     * Get the [optionally formatted] temporal [token_expire_ts] column value.
     *
     *
     ...
     */
    public function getTokenExpireTs($format = NULL)
    {
        if ($format === null) {
            return $this->token_expire_ts;
        } else {
            return $this->token_expire_ts instanceof \DateTimeInterface ? $this->token_expire_ts->format($format) : null;
        }
    }
     ...
     * @return $this|\EmiAdvisors\User The current object (for fluent API support)
     */
    ...
    public function setOrganization($v)
    {
        ...
        if ($this->organization !== $v) {
            $this->organization = $v;
            $this->modifiedColumns[UserTableMap::COL_ORGANIZATION] = true;
        }
    ...
    /**
     * Sets the value of [token_expire_ts] column to a normalized version of the date/time value specified.
     *
     * @param  mixed $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\EmiAdvisors\User The current object (for fluent API support)
     */
    public function setTokenExpireTs($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->token_expire_ts !== null || $dt !== null) {
            if ($this->token_expire_ts === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->token_expire_ts->format("Y-m-d H:i:s.u")) {
                $this->token_expire_ts = $dt === null ? null : clone $dt;
                $this->modifiedColumns[UserTableMap::COL_TOKEN_EXPIRE_TS] = true;
            }
    ...
    public function setCreatedTs($v)
    {
        ...
        if ($this->created_ts !== null || $dt !== null) {
            if ($this->created_ts === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_ts->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[UserTableMap::COL_CREATED_TS] = true;
            }
        } // if either are not null
    ...
    public function setUpdatedTs($v)
    {
        ...
        if ($this->updated_ts !== null || $dt !== null) {
            if ($this->updated_ts === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_ts->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[UserTableMap::COL_UPDATED_TS] = true;
            }
        } // if either are not null
    ...
    public function setValid($v)
    {
        ...
        if ($this->valid !== $v) {
            $this->valid = $v;
            $this->modifiedColumns[UserTableMap::COL_VALID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : UserTableMap::translateFieldName('Organization', TableMap::TYPE_PHPNAME, $indexType)];
            $this->organization = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : UserTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : UserTableMap::translateFieldName('Token', TableMap::TYPE_PHPNAME, $indexType)];
            $this->token = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : UserTableMap::translateFieldName('TokenExpireTs', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->token_expire_ts = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : UserTableMap::translateFieldName('CreatedTs', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_ts = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : UserTableMap::translateFieldName('UpdatedTs', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->updated_ts = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : UserTableMap::translateFieldName('Active', TableMap::TYPE_PHPNAME, $indexType)];
            $this->active = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : UserTableMap::translateFieldName('Valid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\EmiAdvisors\\User'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_ORGANIZATION)) {
        ...
        if ($this->isColumnModified(UserTableMap::COL_TOKEN_EXPIRE_TS)) {
            $modifiedColumns[':p' . $index++]  = 'token_expire_ts';
        }
        if ($this->isColumnModified(UserTableMap::COL_CREATED_TS)) {
            $modifiedColumns[':p' . $index++]  = 'created_ts';
        }
        if ($this->isColumnModified(UserTableMap::COL_UPDATED_TS)) {
            $modifiedColumns[':p' . $index++]  = 'updated_ts';
        }
        if ($this->isColumnModified(UserTableMap::COL_ACTIVE)) {
            $modifiedColumns[':p' . $index++]  = 'active';
        }
        if ($this->isColumnModified(UserTableMap::COL_VALID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'token':
                        ...
                        break;
                    case 'token_expire_ts':
                        $stmt->bindValue($identifier, $this->token_expire_ts ? $this->token_expire_ts->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'created_ts':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[6] => $this->getOrganization(),
            $keys[7] => $this->getTitle(),
            $keys[8] => $this->getRole(),
            $keys[9] => $this->getToken(),
            $keys[10] => $this->getTokenExpireTs(),
            $keys[11] => $this->getCreatedTs(),
            $keys[12] => $this->getUpdatedTs(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) {
            $this->setOrganization($arr[$keys[6]]);
        }
        ...
        if (array_key_exists($keys[10], $arr)) {
            $this->setTokenExpireTs($arr[$keys[10]]);
        }
        if (array_key_exists($keys[11], $arr)) {
            $this->setCreatedTs($arr[$keys[11]]);
        }
        if (array_key_exists($keys[12], $arr)) {
            $this->setUpdatedTs($arr[$keys[12]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\EmiAdvisors\User The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_ORGANIZATION)) {
            $criteria->add(UserTableMap::COL_ORGANIZATION, $this->organization);
        }
        if ($this->isColumnModified(UserTableMap::COL_TITLE)) {
        ...
        if ($this->isColumnModified(UserTableMap::COL_TOKEN_EXPIRE_TS)) {
            $criteria->add(UserTableMap::COL_TOKEN_EXPIRE_TS, $this->token_expire_ts);
        }
        if ($this->isColumnModified(UserTableMap::COL_CREATED_TS)) {
            $criteria->add(UserTableMap::COL_CREATED_TS, $this->created_ts);
        }
        if ($this->isColumnModified(UserTableMap::COL_UPDATED_TS)) {
            $criteria->add(UserTableMap::COL_UPDATED_TS, $this->updated_ts);
        }
        if ($this->isColumnModified(UserTableMap::COL_ACTIVE)) {
            $criteria->add(UserTableMap::COL_ACTIVE, $this->active);
        }
        if ($this->isColumnModified(UserTableMap::COL_VALID)) {
            $criteria->add(UserTableMap::COL_VALID, $this->valid);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EmiAdvisors\User (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setTokenExpireTs($this->getTokenExpireTs());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EmiAdvisors\User Clone of current object.
     * @throws PropelException
     */
