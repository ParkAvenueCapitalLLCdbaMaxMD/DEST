...
use \Exception;
use \PDO;
use EmiAdvisors\EmiAdvisors\User as ChildUser;
...
abstract class UserQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \EmiAdvisors\EmiAdvisors\Base\UserQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\EmiAdvisors\\EmiAdvisors\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, email, password, salt, first_name, last_name, role, token, token_expire_ts, created_ts, updated_ts, active, valid FROM user WHERE id = :p0';
        try {
