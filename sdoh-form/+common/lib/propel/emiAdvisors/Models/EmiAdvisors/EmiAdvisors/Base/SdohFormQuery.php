...
use \Exception;
use \PDO;
use EmiAdvisors\EmiAdvisors\SdohForm as ChildSdohForm;
...
abstract class SdohFormQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \EmiAdvisors\EmiAdvisors\Base\SdohFormQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\EmiAdvisors\\EmiAdvisors\\SdohForm', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, user_id, domain, screening_data, diagnoses_data, goals_data, intervention_data, status, created_ts, updated_ts, valid FROM sdoh_form WHERE id = :p0';
        try {
