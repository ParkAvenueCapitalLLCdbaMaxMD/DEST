...
namespace EmiAdvisors\EmiAdvisors\Base;

use \DateTime;
use \Exception;
use \PDO;
use EmiAdvisors\EmiAdvisors\UserQuery as ChildUserQuery;
use EmiAdvisors\EmiAdvisors\Map\UserTableMap;
 ...
 *
 *
 * @package    propel.generator.EmiAdvisors.EmiAdvisors.Base
 */
abstract class User implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\EmiAdvisors\\EmiAdvisors\\Map\\UserTableMap';
    ...
    /**
     * Initializes internal state of EmiAdvisors\EmiAdvisors\Base\User object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\EmiAdvisors\EmiAdvisors\User The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : UserTableMap::translateFieldName('TokenExpireTs', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->token_expire_ts = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : UserTableMap::translateFieldName('CreatedTs', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_ts = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : UserTableMap::translateFieldName('UpdatedTs', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->updated_ts = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : UserTableMap::translateFieldName('Active', TableMap::TYPE_PHPNAME, $indexType)];
            $this->active = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : UserTableMap::translateFieldName('Valid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\EmiAdvisors\\EmiAdvisors\\User'), 0, $e);
        }
    }
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[8] => $this->getTokenExpireTs(),
            $keys[9] => $this->getCreatedTs(),
            $keys[10] => $this->getUpdatedTs(),
            $keys[11] => $this->getActive(),
            $keys[12] => $this->getValid(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\EmiAdvisors\EmiAdvisors\User
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[8], $arr)) {
            $this->setTokenExpireTs($arr[$keys[8]]);
        }
        if (array_key_exists($keys[9], $arr)) {
            $this->setCreatedTs($arr[$keys[9]]);
        }
        if (array_key_exists($keys[10], $arr)) {
            $this->setUpdatedTs($arr[$keys[10]]);
        }
        if (array_key_exists($keys[11], $arr)) {
            $this->setActive($arr[$keys[11]]);
        }
        if (array_key_exists($keys[12], $arr)) {
            $this->setValid($arr[$keys[12]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\EmiAdvisors\EmiAdvisors\User The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EmiAdvisors\EmiAdvisors\User (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EmiAdvisors\EmiAdvisors\User Clone of current object.
     * @throws PropelException
     */
