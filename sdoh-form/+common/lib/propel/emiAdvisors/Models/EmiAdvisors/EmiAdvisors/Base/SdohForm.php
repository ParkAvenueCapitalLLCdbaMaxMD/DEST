...
use \Exception;
use \PDO;
use EmiAdvisors\EmiAdvisors\SdohFormQuery as ChildSdohFormQuery;
use EmiAdvisors\EmiAdvisors\Map\SdohFormTableMap;
...
abstract class SdohForm implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\EmiAdvisors\\EmiAdvisors\\Map\\SdohFormTableMap';
    ...
    /**
     * Initializes internal state of EmiAdvisors\EmiAdvisors\Base\SdohForm object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\EmiAdvisors\EmiAdvisors\SdohForm The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SdohFormTableMap::translateFieldName('ScreeningData', TableMap::TYPE_PHPNAME, $indexType)];
            $this->screening_data = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SdohFormTableMap::translateFieldName('DiagnosesData', TableMap::TYPE_PHPNAME, $indexType)];
            $this->diagnoses_data = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SdohFormTableMap::translateFieldName('GoalsData', TableMap::TYPE_PHPNAME, $indexType)];
            $this->goals_data = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SdohFormTableMap::translateFieldName('InterventionData', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intervention_data = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : SdohFormTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : SdohFormTableMap::translateFieldName('CreatedTs', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_ts = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : SdohFormTableMap::translateFieldName('UpdatedTs', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->updated_ts = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : SdohFormTableMap::translateFieldName('Valid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 11; // 11 = SdohFormTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\EmiAdvisors\\EmiAdvisors\\SdohForm'), 0, $e);
        }
    }
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getScreeningData(),
            $keys[4] => $this->getDiagnosesData(),
            $keys[5] => $this->getGoalsData(),
            $keys[6] => $this->getInterventionData(),
            $keys[7] => $this->getStatus(),
            $keys[8] => $this->getCreatedTs(),
            $keys[9] => $this->getUpdatedTs(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\EmiAdvisors\EmiAdvisors\SdohForm
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setScreeningData($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setDiagnosesData($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setGoalsData($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setInterventionData($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setStatus($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setCreatedTs($arr[$keys[8]]);
        }
        if (array_key_exists($keys[9], $arr)) {
            $this->setUpdatedTs($arr[$keys[9]]);
        }
        if (array_key_exists($keys[10], $arr)) {
            $this->setValid($arr[$keys[10]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\EmiAdvisors\EmiAdvisors\SdohForm The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EmiAdvisors\EmiAdvisors\SdohForm (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EmiAdvisors\EmiAdvisors\SdohForm Clone of current object.
     * @throws PropelException
     */
